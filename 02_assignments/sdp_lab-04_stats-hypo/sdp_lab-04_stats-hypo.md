...
1. **Контекст DOU і локального CSV не тотожний.** Стаття DOU використовує власний аналітичний пайплайн і редакційні правила, тоді як лабораторна спирається на технічний сирий експорт `04_data/2025_dec_raw.csv`.
