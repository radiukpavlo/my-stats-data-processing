...
**Проміжний висновок:** локальний розподіл є правосторонньо асиметричним: середнє **3815.95 USD** перевищує медіану **3500.00 USD**, що узгоджується з наявністю довгого правого хвоста високих компенсацій.
...
2. Середня `salary_usd_net` дорівнює **3815.95 USD**.
3. Медіанна `salary_usd_net` дорівнює **3500.00 USD**.
4. Стандартне відхилення `salary_usd_net` становить **2354.12 USD**.
...
1. **Відмінність від публікованих медіан:** локальний CSV є сирішим технічним набором, ніж опрацьований масив для публікації DOU, тому лабораторний результат не зобов’язаний збігатися з медіаною **3450 USD**, наведеною в статті.
